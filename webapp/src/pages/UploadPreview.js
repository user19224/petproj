...
export const UploadPreview = () => {
  ...
  const handleWeightChange = (col, val) => {
    setCriteria((prev) =>
      Object.assign(Object.assign({}, prev), {
        [col]: Object.assign(Object.assign({}, prev[col]), { weight: val }),
      }),
    )
  }
  const handleDirectionToggle = (col) => {
    setCriteria((prev) =>
      Object.assign(Object.assign({}, prev), {
        [col]: Object.assign(Object.assign({}, prev[col]), {
  ...
  if (step === 'results') {
    return _jsx('div', {
      ...
      children: _jsxs('div', {
        ...
        children: [
          _jsx('h1', { children: 'Results' }),
          _jsxs('div', {
            className: 'best-cards',
            children: [
              _jsxs('div', {
                className: 'best-card',
                children: [
            ...
            children: _jsxs('table', {
              ...
              children: [
                _jsx('thead', {
                  children: _jsxs('tr', {
                    children: [
                      _jsx('th', { children: 'Index' }),
                      headers.map((h) => _jsx('th', { children: h }, h)),
                      headers.map((h) =>
                        _jsx('th', { children: `Norm ${h}` }, `n-${h}`),
                      ),
                    ...
                    _jsxs(
                      'tr',
                      {
                        ...
                        children: [
                          ...
                          headers.map((h) =>
                            _jsx('td', { children: r.original[h] }, h),
                          ),
                          headers.map((h) =>
                            _jsx(
                              'td',
                              { children: r.normalized[h].toFixed(3) },
                              `n-${h}`,
                            ),
                          ),
                          _jsx('td', { children: r.additive }),
                          _jsx('td', { children: r.distance }),
                        ],
                      },
                      r.index,
                    ),
    ...
    children: _jsxs('div', {
      ...
      children: [
                ...
                children: [
                  _jsxs('div', {
                    ...
                    children: [
                      ...
                      _jsx('span', {
                        children: file ? file.name : 'Файл не выбран',
                      }),
                    ],
                  }),
                  _jsx('button', {
                    ...
                    children: loading ? 'Uploading...' : 'Upload & Next',
                  }),
        ...
        step === 'weights' &&
          _jsxs(_Fragment, {
            children: [
              _jsx('h1', { children: 'Setup Criteria' }),
              error && _jsx('div', { className: 'error', children: error }),
              _jsx('div', {
                  ...
                  _jsxs(
                    'div',
                    {
                      ...
                      children: [
                        ...
                        _jsx('span', {
                          children: criteria[col].weight.toFixed(1),
                        }),
                        _jsx('button', {
